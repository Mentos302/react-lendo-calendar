...
export default function Playground() {
    ...
    const [newUnavailableDates, setNewUnavailableDates] = useState({ startDate: "", endDate: "" });
                ...
                <div className="w-full sm:w-1/3 pr-2 flex flex-row flex-wrap sm:flex-col">
                    ...
                    <div className="mb-2 w-1/2 sm:w-full">
                        <div className="inline-flex items-center">
                            ...
                            />
                            <label className="block" htmlFor="enableSaturday">
                                Enable Saturday
                            </label>
                        </div>
                    </div>
                    ...
                    <div className="sm:col-start-2 sm:col-span-2 p-2 border-t grid grid-cols-2">
                        ...
                        <div className="mb-2 sm:col-span-2 mr-2">
                            ...
                            <input
                                className="rounded border px-4 py-2 border-gray-200 sm:w-full w-3/4"
                                id="startDate"
                                value={newUnavailableDates.startDate}
                                onChange={e => {
                        ...
                        <div className="mb-2">
                            ...
                            <input
                                className="rounded border px-4 py-2 border-gray-200 sm:w-full w-3/4"
                                id="endDate"
                                value={newUnavailableDates.endDate}
                                onChange={e => {
                                    setNewUnavailableDates(prev => {
                                        return {
                                            ...prev,
                        ...
                        <div className="mb-2 col-span-3">
                            <button
                                onClick={() => {
                                    if (
                                        newUnavailableDates.startDate !== "" &&
                                        newUnavailableDates.endDate !== ""
                                    ) {
                                        setUnavailableDates(prev => [...prev, newUnavailableDates]);
                                        setNewUnavailableDates({ startDate: "", endDate: "" });
                                    }
                                }}
                                className="w-full bg-black text-white text-lg text-center p-2 rounded-lg"
                            >
                            ...
                            {unavailableDates.map((range, index) => (
                                <div className="mb-2 p-2" key={index}>
                                    <button
                                        ...
                                        onClick={() => {
                                            setUnavailableDates(
                                                unavailableDates.filter(r => r !== range)
                                            );
                                        }}
                                    >
                                        Delete
